<?php
if (!function_exists('Dwoo_Plugin_headMaps_58471c6700d7a')) {
function Dwoo_Plugin_headMaps_58471c6700d7a(Dwoo $dwoo, $maps, $pathBase, $currentMap, $indent = 1) {
static $_callCnt = 0;
$dwoo->scope[' 58471c6700d7a'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 58471c6700d7a'.($_callCnt++)));
...
echo Dwoo_Plugin_headMaps_58471c6700d7a($dwoo, (isset($dwoo->scope["map"]["childs"]) ? $dwoo->scope["map"]["childs"]:null), (isset($dwoo->scope["pathBase"]) ? $dwoo->scope["pathBase"] : null), (isset($dwoo->scope["currentMap"]) ? $dwoo->scope["currentMap"] : null), ((isset($dwoo->scope["indent"]) ? $dwoo->scope["indent"] : null) + 1));
...
if (!function_exists('Dwoo_Plugin_sideMaps_58471c6713db0')) {
function Dwoo_Plugin_sideMaps_58471c6713db0(Dwoo $dwoo, $maps, $pathBase, $showStates, $currentMap, $indent = 1) {
static $_callCnt = 0;
$dwoo->scope[' 58471c6713db0'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 58471c6713db0'.($_callCnt++)));
$dwoo->scope['maps'] = $maps;
$dwoo->scope['pathBase'] = $pathBase;
...
?>
              ...
              <?php echo Dwoo_Plugin_headMaps_58471c6700d7a($this, (isset($this->scope["maps"]) ? $this->scope["maps"] : null), (isset($this->scope["pathBase"]) ? $this->scope["pathBase"] : null), (isset($this->scope["currentMap"]) ? $this->scope["currentMap"] : null), 1);?>
...
?><li class="spacerbottom"><div><a href="<?php echo $this->scope["pathBase"];?>/frontend/nagvis-js/index.php"><?php echo $this->scope["langOverview"];?></a></div></li><?php 
    ...
    <li class="closed"><div><a id="sb-maps" class="title" href="#" onclick="sidebarToggleSubtree(this);return false;"><?php echo $this->scope["langMaps"];?></a></div>
        <ul id="sb-maps-childs" style="display:none;"><?php echo Dwoo_Plugin_sideMaps_58471c6713db0($this, (isset($this->scope["maps"]) ? $this->scope["maps"] : null), (isset($this->scope["pathBase"]) ? $this->scope["pathBase"] : null), (isset($this->scope["showStates"]) ? $this->scope["showStates"] : null), (isset($this->scope["currentMap"]) ? $this->scope["currentMap"] : null), 1);?></ul>
    </li>
